...
public class SocketDetail {
    ...
    /**
     * @param statusOpen the statusOpen to set
     */
    ...
    /**
     * @param statusConnect the statusConnect to set
     */
     ...
     * @return the todirect
     */
    public String getTodirect() {
        return todirect;
    }

    /**
     * @param todirect the todirect to set
     */
    public void setTodirect(String todirect) {
