...
public class IsoServlet extends HttpServlet {
    ...
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(IsoServlet.class);
...
//            String bankcode = "bca";
            ...
            Logger.getLogger(IsoServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
