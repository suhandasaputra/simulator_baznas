 ...
 * @author matajari
 */
@WebServlet(name = "DelFieldServlet", urlPatterns = {"/DelFieldServlet"})
public class DelFieldServlet extends HttpServlet {

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(DelFieldServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String status = dp.deletefield(field, bankcode);
        ...
        if ("00".equals(status)) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(DelFieldServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
